...
const youtubeVideos = {
    getVideos: () => {
        locations.forEach(location => {
            let url = `https://www.googleapis.com/youtube/v3/videos?part=snippet%2Cstatistics&chart=mostpopular&maxResults=50&key=${process.env.GOOGLE_API_KEY}`;
